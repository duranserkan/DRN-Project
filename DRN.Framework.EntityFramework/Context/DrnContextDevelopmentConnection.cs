...
public static class DrnContextDevelopmentConnection
{
    public static string GetConnectionString(IAppSettings appSettings, string name)
    {
        ...
        else
        {
            ...
            if (password != null)
                connectionString = $"Host={host};Port={port};Database={database};User ID={username};password={password};Multiplexing=false;Max Auto Prepare=10;Maximum Pool Size=5;Application Name={AppConstants.EntryAssemblyName};";
        }
