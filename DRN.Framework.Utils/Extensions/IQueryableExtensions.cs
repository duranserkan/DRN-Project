...
public static class IQueryableExtensions
{
    ...
    public static IQueryable<TEntity> EntityCreatedAfter<TEntity>(this IQueryable<TEntity> query, DateTimeOffset dateBeforeCreation, 
    ...
    public static IQueryable<TEntity> EntityCreatedBefore<TEntity>(this IQueryable<TEntity> query, DateTimeOffset dateAfterCreation,
        bool inclusive = true) where TEntity : Entity
        => inclusive
