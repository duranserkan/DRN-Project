...
/// </summary>
public abstract class DrnException(string message, Exception? exception, string? category, short? status = null)
...
/// </summary>
public class ValidationException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 400);

/// <summary>
/// Scope handler returns 401 when thrown
/// </summary>
public class UnauthorizedException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 401);

/// <summary>
/// Scope handler returns 403 when thrown
/// </summary>
public class ForbiddenException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 403);

/// <summary>
/// Scope handler returns 404 when thrown
/// </summary>
public class NotFoundException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 404);

/// <summary>
/// Scope handler returns 409 when thrown
/// </summary>
public class ConflictException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 409);

/// <summary>
/// Scope handler returns 410 when thrown
/// </summary>
public class ExpiredException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 410);

/// <summary>
/// Scope handler returns 500 when thrown
/// </summary>
public class ConfigurationException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 500);

/// <summary>
/// Scope handler returns 422 when thrown
/// </summary>
public class UnprocessableEntityException(string message, Exception? exception = null, string? category = null)
    : DrnException(message, exception, category, 422);
