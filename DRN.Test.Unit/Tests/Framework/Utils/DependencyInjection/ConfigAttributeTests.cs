...
public class ConfigAttributeTests
{
    ...
    [Theory]
    [DataInlineUnit]
    public void EnvironmentConfig_Should_Be_Resolved(DrnTestContextUnit context)
    {
    ...
    [Theory]
    [DataInlineUnit]
    public void Config_Should_Be_Resolved(DrnTestContextUnit context)
    {
        context.ServiceCollection.AddServicesWithAttributes();
    ...
    [Theory]
    [DataInlineUnit]
    public void Config_Should_Be_Resolved_With_NonPublicValue(DrnTestContextUnit context)
    {
        context.ServiceCollection.AddServicesWithAttributes();
    ...
    [Theory]
    [DataInlineUnit]
    public void Config_Should_Be_Resolved_With_NonPublicValue_Unbound(DrnTestContextUnit context)
    {
        context.ServiceCollection.AddServicesWithAttributes();
