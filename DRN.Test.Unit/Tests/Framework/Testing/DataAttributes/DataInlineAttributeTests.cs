...
public class DataInlineAttributeTests
{
    ...
    [Theory]
    [DataInlineUnit]
    public void DataInlineContextDemonstration(DrnTestContextUnit context, IMockable autoInlinedDependency)
    {
    ...
    [Theory]
    [DataInlineUnit(99)]
    public void TextContext_Should_Be_Created_From_DrnTestContextData(DrnTestContextUnit context, int inlineData, Guid autoInlinedData, IMockable autoInlinedMockable)
    {
