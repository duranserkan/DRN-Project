---
name: buildwww-vite
description: Sample.Hosted buildwww structure, Vite configuration, TypeScript setup, and multi-build patterns
---
...
BUILD_TYPE=htmx npm run build
BUILD_TYPE=bootstrap npm run build
...
- [14-buildwww-libraries.md](file:///Users/duranserkankilic/Work/Drn-Project/.agent/skills/14-buildwww-libraries.md) - Library usage
- [15-razor-pages-shared.md](file:///Users/duranserkankilic/Work/Drn-Project/.agent/skills/15-razor-pages-shared/SKILL.md) - Layout integration
