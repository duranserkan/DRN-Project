...
| Test-context/application provider ownership and host lifecycle | [DrnTestContext.cs](../DRN.Framework.Testing/Contexts/DrnTestContext.cs), [ApplicationContext.cs](../DRN.Framework.Testing/Contexts/Application/ApplicationContext.cs) | Testing README, Testing release notes, `drn-testing` skill |
