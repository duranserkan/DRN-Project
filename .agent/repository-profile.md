...
| Renewal timestamp and MFA evidence binding | [MfaClaimPreservation.cs](../DRN.Framework.Hosting/Auth/MfaClaimPreservation.cs), [MfaClaimPreservationTests.cs](../DRN.Test.Unit/Tests/Framework/Hosting/Auth/MfaClaimPreservationTests.cs) | Hosting README, release notes, `drn-hosting`; retain marker provenance with issuer-aware deduplication and never combine split evidence into recent-MFA assurance |
