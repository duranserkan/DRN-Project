...
the forgery likelihood is \(2^{-20}\), approximately one in a million.
At 100 rate-limited attempts per second, this \(2^{12}\) budget is
exhausted in roughly 41 seconds.
