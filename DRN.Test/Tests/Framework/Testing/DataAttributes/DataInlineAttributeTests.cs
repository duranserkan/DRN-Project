...
public class DataInlineAttributeTests
{
    ...
    [Theory]
    [DataInline]
    public void DataInlineContextDemonstration(DrnTestContext context, IMockable autoInlinedDependency)
    {
    ...
    [Theory]
    [DataInline]
    public void TextContext_Should_Provide_AppSettings(DrnTestContext context)
    {
        var serviceProvider = context.BuildServiceProvider(); //appsettings.json added by convention. Context and service provider will be disposed by xunit
