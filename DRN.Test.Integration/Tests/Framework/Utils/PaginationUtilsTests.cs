...
namespace DRN.Test.Integration.Tests.Framework.Utils;
...
public class PaginationUtilsTests
{
    ...
    public async Task PaginationUtils_Should_Return_Paginated_Result(DrnTestContext context, int totalCount, int pageSize, bool updateTotalCount, PageSortDirection pageSortDirection)
    {
        ...
        var request = PaginationRequest.DefaultWith(pageSize, PageSize.MaxSizeDefault, direction: pageSortDirection, updateTotalCount: updateTotalCount);
        ...
        request = PaginationRequest.DefaultWith(pageSize, PageSize.MaxSizeDefault, direction: pageSortDirection, updateTotalCount: updateTotalCount);
