...
| **Infras.** | `ConfigureResponseCompressionOptions` | Configure response compression (Brotli/Gzip) for whitelisted static asset MIME types (CSS, JS, SVG, TTF, OTF) with HTTPS compression enabled. |
