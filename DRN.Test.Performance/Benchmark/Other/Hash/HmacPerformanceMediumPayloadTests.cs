...
public class HmacPerformanceMediumPayloadTests(ITestOutputHelper output)
{
#if !DEBUG
    ...
    public void Run_Benchmarks()
    {
        ...
        var summary = BenchmarkRunner.Run<HashBenchmarkMediumPayload>(config);
...
public class HashBenchmarkMediumPayload
{
    ...
    [Params(32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768)]
